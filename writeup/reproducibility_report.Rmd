...
To determine if either interrupted or continuous left OTS - which came out as most predictive of reading in the multiple linear regressions - better predicted reading abilities, we conducted a t-test comparing reading scores of subjects with interrupted left hemisphere OTS and subjects with continuous left hemisphere OTS.
...
Successful reproduction will include finding that the left OTS is a better predictor of reading abilities than right OTS or age. Additionally, successful reproduction must find that an interrupted left OTS better predcits reading abilities than a continous left OTS.
